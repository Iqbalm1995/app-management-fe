...
export const MOCK_CAB_LIST: CabRequestItem[] = [
  ...
  // ── IMPLEMENTASI (Evaluated & Checklist done) ──
  {
    id: "cab-005",
    ...
    isCabDone: "Y",
    cabResult: "APPROVED",
    cabNotes: "Patch JWT session expiry fix telah disetujui komite.",
  ...
  // ── COMPLETED (Current Month & Day - 02 September 2026) ──
  {
    id: "cab-021",
    requestNo: "0001/CAB/09/2026",
    requestTitle: "Release Microservices Account Mutation v3.4",
    requestType: "NEW FEATURE",
    category: "SOFTWARE",
    requestDate: "2026-08-28",
    targetDate: "2026-09-02",
    requestedCabDate: "2026-09-01T09:00:00",
    scheduledDate: "2026-09-02T09:00:00",
    scheduledEndDate: "2026-09-02T10:30:00",
    status: "COMPLETED",
    isCabDone: "Y",
    cabResult: "APPROVED",
    cabNotes: "Disetujui penuh oleh Komite CAB. Seluruh checklist kepatuhan telah diverifikasi.",
    cabLocation: "Ruang Rapat IT Lt. 3",
    requesterName: "Iqbal Maulana",
    approverName: "Ahmad Fauzi",
    projectName: "DIGI Mobile Banking",
    priority: "HIGH",
    buktiImplementasi: [
      {
        id: "bukti-021-1",
        name: "evidence_meeting_cab_0902.png",
        size: 614400,
        url: "https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=800&auto=format&fit=crop&q=60",
        type: "image/png",
  ...
  // ── COMPLETED (Current Month - 01 September 2026) ──
  {
    id: "cab-022",
    requestNo: "0002/CAB/09/2026",
    requestTitle: "Firmware Patching Load Balancer Datacenter Utama",
    requestType: "ENHANCEMENT",
    category: "HARDWARE",
    requestDate: "2026-08-25",
    targetDate: "2026-09-01",
    requestedCabDate: "2026-08-31T14:00:00",
    scheduledDate: "2026-09-01T13:30:00",
    scheduledEndDate: "2026-09-01T15:00:00",
    status: "COMPLETED",
    isCabDone: "Y",
    cabResult: "APPROVED WITH NOTE",
    cabNotes: "Disetujui dengan catatan: Monitoring CPU load selama 24 jam pasca-patching.",
    cabLocation: "DC Sudirman Lt. 2",
    requesterName: "Deni Saputra",
    approverName: "Budi Santoso",
    projectName: "Datacenter Load Balancer Optimization",
    priority: "MEDIUM",
    buktiImplementasi: [
      {
        id: "bukti-022-1",
        name: "verification_load_balancer_patch.png",
        size: 450560,
        url: "https://images.unsplash.com/photo-1504868584819-f8e8b4b6d7e3?w=800&auto=format&fit=crop&q=60",
        type: "image/png",
...
export const MOCK_CAB_DETAIL: Record<string, CabRequestDetail> = {
  "cab-001": {
    ...
    committeeCab: [
      { id: "com-01", type: "INTERNAL_IT", userName: "Ahmad Fauzi", asalDivisi: "Divisi IT Architecture" },
      { id: "com-02", type: "INTERNAL_BJB", userName: "Budi Santoso", asalDivisi: "Divisi IT Operations" },
      { id: "com-03", type: "INTERNAL_BJB", userName: "Refan Hidayat", asalDivisi: "Divisi Risk Management" },
      { id: "com-04", type: "INTERNAL_IT", userName: "Deni Saputra", asalDivisi: "Divisi IT Security" },
    ],
    approvalHistory: [],
  ...
  "cab-002": {
    ...
    committeeCab: [
      { id: "com-02-1", type: "INTERNAL_IT", userName: "Ahmad Fauzi", asalDivisi: "Divisi IT Architecture" },
      { id: "com-02-2", type: "INTERNAL_BJB", userName: "Budi Santoso", asalDivisi: "Divisi IT Operations" },
      { id: "com-02-3", type: "INTERNAL_BJB", userName: "Refan Hidayat", asalDivisi: "Divisi Risk Management" },
      { id: "com-02-4", type: "INTERNAL_IT", userName: "Deni Saputra", asalDivisi: "Divisi IT Security" },
      { id: "com-02-5", type: "INTERNAL_BJB", userName: "Hendra Wijaya", asalDivisi: "Business Operations" },
    ],
    approvalHistory: [
      {
        id: "ap-002-1",
  ...
  "cab-003": {
    ...
    committeeCab: [
      { id: "com-03-1", type: "INTERNAL_IT", userName: "Budi Santoso", asalDivisi: "Divisi IT Infrastructure" },
      { id: "com-03-2", type: "INTERNAL_IT", userName: "Deni Saputra", asalDivisi: "Divisi IT Security" },
      { id: "com-03-3", type: "INTERNAL_BJB", userName: "Ahmad Fauzi", asalDivisi: "Divisi IT Architecture" },
    ],
    approvalHistory: [],
    activityChecklist: DEFAULT_CAB_ACTIVITIES.map((act) => ({ ...act })),
  },
  "cab-005": {
    ...
    committeeCab: [
      { id: "com-05-1", type: "INTERNAL_IT", userName: "Ahmad Fauzi", asalDivisi: "Divisi IT Architecture" },
      { id: "com-05-2", type: "INTERNAL_BJB", userName: "Budi Santoso", asalDivisi: "Divisi IT Operations" },
      { id: "com-05-3", type: "INTERNAL_IT", userName: "Iqbal Maulana", asalDivisi: "Application Development" },
    ],
    approvalHistory: [],
    activityChecklist: DEFAULT_CAB_ACTIVITIES.map((act) => ({ ...act, isDone: true })),
  },
