...
export interface ProjectByGroupManageDashboardResponse {
  projectGroupNameManage: string;
  projectCount: number;
}

export interface DevStaffProjectClosedDashboardResponse {
  userFullName: string;
  projectCount: number;
  monthName: string;
}

export interface DevStaffProjectActiveDashboardResponse {
  userFullName: string;
  projectCount: number;
  monthName: string;
}
