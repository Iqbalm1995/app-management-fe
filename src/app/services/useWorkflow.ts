  ...
  const ListWorkflowGroups = async (
    ...
    try {
      ...
      if (axios.isAxiosError(err)) {
        ...
        setError(
          err.response?.data?.message || "An error occurred while fetching workflow groups."
        );
  ...
  const GetWorkflowGroupById = async (
    ...
    try {
      ...
      if (axios.isAxiosError(err)) {
        const errorResponse = handleAxiosError(err);
        setError(
          err.response?.data?.message || "An error occurred while fetching workflow group details."
        );
        return errorResponse;
      } else {
        setError("An unknown error occurred. Please try again.");
  ...
  const GetWorkflowGroupByCode = async (
    ...
    try {
      ...
      if (axios.isAxiosError(err)) {
        const errorResponse = handleAxiosError(err);
        setError(
          err.response?.data?.message || "An error occurred while fetching workflow group details by code."
        );
        return errorResponse;
      } else {
        setError("An unknown error occurred. Please try again.");
  ...
  const InsertWorkflowGroup = async (
    ...
    try {
      ...
      if (axios.isAxiosError(err)) {
        const errorResponse = handleAxiosError(err);
        setError(
          err.response?.data?.message || "An error occurred while inserting workflow group."
        );
        return errorResponse;
      } else {
        setError("An unknown error occurred. Please try again.");
  ...
  const UpdateWorkflowGroup = async (
    ...
    try {
      ...
      if (axios.isAxiosError(err)) {
        const errorResponse = handleAxiosError(err);
        setError(
          err.response?.data?.message || "An error occurred while updating workflow group."
        );
        return errorResponse;
      } else {
        setError("An unknown error occurred. Please try again.");
  ...
  const DeleteWorkflowGroup = async (
    ...
    try {
      ...
      if (axios.isAxiosError(err)) {
        const errorResponse = handleAxiosError(err);
        setError(
          err.response?.data?.message || "An error occurred while deleting workflow group."
        );
        return errorResponse;
      } else {
        setError("An unknown error occurred. Please try again.");
