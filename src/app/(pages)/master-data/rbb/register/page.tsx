...
import useMstRbb, { MstRbbInsertPayload, MstRbbWorkProgramInsertPayload } from "@/app/services/useMstRbb";
...
const HeaderDataContent: HeaderContentProps = {
  ...
  breadCrumb: ["Home", "Master Data", "Master RBB", "Register Target"],
};
...
export default function RegisterMasterRbbPage() {
  ...
  const [validatedPayload, setValidatedPayload] = useState<MstRbbInsertPayload | null>(null);
  ...
  // Submit Countdown Timer Interval Safeguard (3 seconds interval countdown)
  useEffect(() => {
  ...
  const handleSubmit = async () => {
    ...
    const payload: MstRbbInsertPayload = {
  ...
  const handleConfirmSubmit = async () => {
    ...
    const res = await RegisterMstRbb(validatedPayload, tokenData);
          ...
          <HStack spacing={4}>
            ...
            <VStack align="start" spacing={0}>
              <Heading size="md" color={colorMode === "light" ? "gray.800" : "white"}>
                Master RBB & Work Programs Creation
              </Heading>
              <Text fontSize="xs" color="gray.500">
                Define Target Code, Strategic Policies, and Dynamic Work Programs Allocation
              </Text>
            </VStack>
          </HStack>
                ...
                <Flex justify="space-between" align="center">
                  <HStack spacing={3}>
                    ...
                    <VStack align="start" spacing={0}>
                      ...
                      <Text fontSize="xs" color="gray.500">
                        Select Organization hierarchy and specify Corporate Target & Policy identifiers
                      </Text>
                    </VStack>
                  </HStack>
                ...
                <Grid templateColumns={{ base: "1fr", md: "repeat(3, 1fr)" }} gap={5}>
                  ...
                  <GridItem>
                    <FormControl isRequired size="sm">
                      ...
                      />
                      <FormHelperText fontSize="3xs">Format placeholder: 1.1.1.1 (Auto UPPERCASE)</FormHelperText>
                    </FormControl>
                  </GridItem>
                    ...
                    <Grid templateColumns={{ base: "1fr", md: "repeat(3, 1fr)" }} gap={5}>
                      ...
                      <GridItem>
                        <FormControl isRequired size="sm">
                          ...
                          />
                          <FormHelperText fontSize="3xs">Placeholder: TECHXX (Auto UPPERCASE)</FormHelperText>
                        </FormControl>
                      </GridItem>
                      ...
                      <GridItem colSpan={{ base: 1, md: 2 }}>
                        <FormControl isRequired size="sm">
                          ...
                          />
                          <FormHelperText fontSize="3xs" color="blue.500">Mixed case allowed</FormHelperText>
                        </FormControl>
                      </GridItem>
                      ...
                      {/* Bundling Input Rembis (Simple Text Box) */}
                      <GridItem>
                        <FormControl size="sm">
                          ...
                          />
                          <FormHelperText fontSize="3xs">Text box (Auto UPPERCASE)</FormHelperText>
                        </FormControl>
                      </GridItem>
                ...
                <Flex justify="space-between" align="center" wrap="wrap" gap={4}>
                  ...
                  <HStack spacing={6} wrap="wrap">
                    ...
                    <Button
                      ...
                      px={8}
                    >
                      Save & Register Master RBB Target
                    </Button>
                  </HStack>
                </Flex>
              </CardBody>
        ...
        <ModalContent rounded="2xl" shadow="2xl">
          <ModalHeader borderBottom="1px" borderColor={colorMode === "light" ? "gray.200" : "gray.700"}>
            <HStack spacing={3}>
              ...
              <Heading size="sm">Confirm Master RBB Target Registration</Heading>
            </HStack>
          </ModalHeader>
          <ModalCloseButton />
          ...
          <ModalBody py={6}>
            <VStack spacing={5} align="stretch">
              <Alert status="info" rounded="xl">
                <AlertIcon />
                <Box>
                  <AlertTitle fontSize="xs" fontWeight="bold">Review Master RBB Configuration</AlertTitle>
                  <AlertDescription fontSize="2xs">
                    Please verify Directorate/Division mappings, Target/Policy/Strategy details, and Work Program allocations before submitting.
                  </AlertDescription>
                </Box>
              </Alert>
          ...
          <ModalFooter borderTop="1px" borderColor={colorMode === "light" ? "gray.200" : "gray.700"}>
            <HStack spacing={3}>
              ...
              <Button
                ...
                shadow="md"
              >
                {submitCountdown > 0 ? `Wait ${submitCountdown}s to Confirm` : "Confirm & Submit Registration"}
              </Button>
            </HStack>
          </ModalFooter>
        </ModalContent>
