...
export default function DevKanbanView() {
  ...
  const handleExecuteBulkImport = async () => {
    ...
    const effectiveBacklogId = currentBacklogId || backlogs[0]?.id || null;
  ...
  const jsonImportExample = useMemo(() => {
    ...
    const exampleSecondBoardName = boards[1]?.boardName || exampleBoardName;
  ...
  }, [boards, currentBacklog, currentBacklogId, backlogs]);
  ...
  const handleDownloadTemplate = () => {
    ...
    link.href = url;
    const safeProjectNo = (selectedProject?.projectNo || projectData?.projectNo || "project").replace(/[/\\?%*:|"<>]/g, "-");
  ...
  const handleProceedToPreview = () => {
    ...
    const targetProject = selectedProject || projectData;
    if (!targetProject?.id) {
    ...
    entries.forEach((entry, idx) => {
      ...
      if (taskBacklogId) {
        const inProject = backlogs.find((b) => b.id === taskBacklogId);
        ...
        const inProject = backlogs.find((b) => b.backlogName.toLowerCase() === matchedBacklogName.toLowerCase());
      ...
      if (!taskBacklogId) {
        taskBacklogId = currentBacklogId || backlogs[0]?.id || "";
        matchedBacklogName = backlogs.find((b) => b.id === taskBacklogId)?.backlogName || currentBacklog?.backlogName || "General Backlog";
      }
  ...
  const availableProjectMembers = useMemo(() => {
    if (projectData?.userAssignment && projectData.userAssignment.length > 0) {
      return projectData.userAssignment;
    }
    if (dataUsers && dataUsers.length > 0) {
      return dataUsers;
    }
    if (currentAuthUser) {
      return [{ id: currentAuthUser.id, userData: currentAuthUser, nama: currentAuthUser.nama || currentAuthUser.email }];
    }
    return [];
  }, [projectData?.userAssignment, dataUsers, currentAuthUser]);

  const currentLoggedInUserName = currentAuthUser?.nama || currentAuthUser?.email || "Current User";
              ...
              <VStack spacing={3.5} align="stretch">
                <Flex justify="space-between" align="center" pr={8} flexWrap="wrap" gap={3}>
                  <HStack spacing={3} align="center">
                    <Icon as={FiCode} color="secondary.400" boxSize={6} />
                    <VStack align="start" spacing={0}>
                      <Text fontSize="lg" fontWeight="bold">
                        Bulk Import Tasks via JSON
                      </Text>
                      <Text fontSize="md" color={isDark ? "gray.400" : "gray.500"}>
                        {selectedProject?.projectName || projectData?.projectName || "Dev Kanban"} • {selectedProject?.projectNo || projectData?.projectNo || ""}
                      </Text>
                    </VStack>
                  </HStack>
                </Flex>
                ...
                {wizardStep === "input" && (
                  <>
                    ...
                    <Box
                      p={4}
                      borderRadius={radiusStyle}
                      bg={isDark ? "rgba(15, 23, 42, 0.6)" : "secondary.50"}
                      border="1px solid"
                      borderColor={isDark ? "secondary.900" : "secondary.200"}
                    >
                      <HStack justify="space-between" mb={3} align="center">
                        <HStack spacing={2} align="center">
                          ...
                          <Text
                            ...
                            textTransform="uppercase"
                            letterSpacing="0.05em"
                            color={isDark ? "secondary.300" : "secondary.700"}
                          >
                            Project Context
                          </Text>
                        </HStack>
                      ...
                      >
                        <Box
                          ...
                          bg={isDark ? "rgba(255, 255, 255, 0.04)" : "white"}
                          border="1px solid"
                          borderColor={isDark ? "whiteAlpha.100" : "secondary.100"}
                        >
                          <Text
                            fontSize="md"
                            fontWeight={600}
                          ...
                          <Text
                            ...
                            color={isDark ? "white" : "gray.800"}
                            isTruncated
                            title={selectedProject?.projectNo || projectData?.projectNo || "-"}
                          >
                            {selectedProject?.projectNo || projectData?.projectNo || "-"}
                          </Text>
                        </Box>
                        ...
                        >
                          ...
                          <Text
                            ...
                            color={isDark ? "white" : "gray.800"}
                            isTruncated
                            title={selectedProject?.projectName || projectData?.projectName || "-"}
                          >
                    ...
                    >
                      ...
                      <GridItem display="flex" flexDirection="column" minW={0} w="full">
                        ...
                        >
                          ...
                          >
                            <HStack spacing={2} align="center">
                              <Icon as={FiCode} color="secondary.400" boxSize={4} />
                              <Text
                                fontSize="md"
                                fontFamily="mono"
                                fontWeight="medium"
                          ...
                          <HStack spacing={0} align="stretch" h={{ base: "320px", lg: "360px", xl: "400px" }} flex={1}>
                            ...
                            <Box position="relative" flex={1} h="full" overflow="hidden">
                              ...
                              <Textarea
                                ...
                                color="transparent"
                                sx={{
                                  caretColor: isDark ? "#c9d1d9" : "#24292f",
                                }}
                                _placeholder={{
                      ...
                      <VStack spacing={3} align="stretch">
                        <Flex justify="space-between" align="center" flexWrap="wrap" gap={2}>
                          <HStack spacing={2} align="center">
                            ...
                            <Text fontSize="md" fontWeight="bold" color={isDark ? "white" : "gray.900"}>
                        ...
                        <Grid templateColumns={{ base: "1fr", md: "repeat(3, 1fr)" }} gap={3}>
                          ...
                          <Box
                            ...
                            cursor="pointer"
                            border="2px solid"
                            borderColor={assignOption === "currentUser" ? "secondary.500" : isDark ? "whiteAlpha.100" : "gray.200"}
                            bg={assignOption === "currentUser" ? (isDark ? "rgba(0, 101, 215, 0.15)" : "blue.50") : (isDark ? "gray.800" : "white")}
                          ...
                          >
                            <VStack align="start" spacing={1.5}>
                              ...
                              <Text fontSize="md" color={isDark ? "gray.300" : "gray.600"}>
                          ...
                          <Box
                            ...
                            cursor="pointer"
                            border="2px solid"
                            borderColor={assignOption === "custom" ? "secondary.500" : isDark ? "whiteAlpha.100" : "gray.200"}
                            bg={assignOption === "custom" ? (isDark ? "rgba(0, 101, 215, 0.15)" : "blue.50") : (isDark ? "gray.800" : "white")}
                          ...
                          <Box
                            ...
                            cursor="pointer"
                            border="2px solid"
                            borderColor={assignOption === "original" ? "secondary.500" : isDark ? "whiteAlpha.100" : "gray.200"}
                            bg={assignOption === "original" ? (isDark ? "rgba(0, 101, 215, 0.15)" : "blue.50") : (isDark ? "gray.800" : "white")}
                        ...
                        {assignOption === "custom" && (
                          ...
                          >
                            <VStack spacing={2.5} align="stretch">
                              <Text fontSize="md" fontWeight="semibold" color={isDark ? "gray.200" : "gray.700"}>
                    ...
                    <Box maxH="460px" overflowY="auto" pr={1}>
                      <VStack spacing={4} align="stretch">
                        {groupedStagedTasks.length === 0 ? (
                              <Box p={6} textAlign="center" borderRadius={radiusStyle} bg={isDark ? "gray.800" : "gray.50"}>
                          ...
                          groupedStagedTasks.map((group) => {
                            ...
                            return (
                              <Box
                                ...
                                overflow="hidden"
                                bg={isDark ? "rgba(30, 27, 75, 0.25)" : "purple.50"}
                              >
                                ...
                                <Flex
                                  ...
                                  justify="space-between"
                                  align="center"
                                  bg={isDark ? "rgba(88, 28, 135, 0.25)" : "purple.100"}
                                  borderBottom="1px solid"
                                ...
                                >
                                  <HStack spacing={2.5} align="center">
                                    ...
                                    <Text fontSize="md" fontWeight="bold" color={isDark ? "white" : "purple.950"}>
                                      {group.backlogName}
                                    </Text>
                                    {group.backlogId && (
                                      ...
                                      >
                                        {isEditing ? (
                                          <VStack spacing={3} align="stretch">
                                            ...
                                            <Grid templateColumns={{ base: "1fr", md: "2fr 1fr 1fr" }} gap={3}>
                                              ...
                                              <Select
                                                ...
                                                fontSize="md"
                                              >
                                                {boards.map((b: TaskBoardViewModel) => (
                                          ...
                                          <VStack spacing={2.5} align="stretch">
                                              ...
                                              >
                                                <Flex justify="space-between" align="center" flexWrap="wrap" gap={2}>
                                                  <HStack spacing={2} align="center">
                                                    ...
                                                    <Text fontSize="md" color={isDark ? "orange.200" : "orange.800"}>
                                            ...
                                            {/* Task Description */}
                                            {task.taskDesc && (
                                              <Text fontSize="md" color={isDark ? "gray.300" : "gray.600"} noOfLines={2}>
                                                {task.taskDesc}
                                              </Text>
                                            )}
                  ...
                  <VStack spacing={4} align="stretch">
                    ...
                    >
                      <VStack spacing={4} align="stretch">
                        ...
                        <Divider borderColor={isDark ? "whiteAlpha.100" : "gray.200"} />

                        <Grid templateColumns={{ base: "1fr", md: "repeat(4, 1fr)" }} gap={3}>
                          <Box p={3} borderRadius={radiusStyle} bg={isDark ? "gray.700" : "white"}>
                        ...
                        <Box mt={2}>
                          <Text fontSize="md" fontWeight="bold" mb={2.5} color={isDark ? "gray.200" : "gray.800"}>
              ...
              <VStack spacing={4} align="stretch">
                <Alert status="info" borderRadius={radiusStyle} fontSize="md">
                  ...
                  <AlertDescription fontSize="md">
                    ...
                    in project <strong>{selectedProject?.projectName || "-"}</strong>. This will update the project Kanban board and mark parent backlogs as in-progress.
                  </AlertDescription>
                </Alert>
