...
export const ModalTopAutoAdjust = ({
  ...
  const [mode, setMode] = useState<"EQUAL" | "PERCENTAGE">("PERCENTAGE");
          ...
          <HStack spacing={3}>
            ...
            <VStack align="start" spacing={0}>
              ...
              <Text fontSize="xs" color="gray.500">
                Automatically calculate step values and percentages from Total Work Value ({formatIDR(workValue)})
              </Text>
            </VStack>
          </HStack>
        </ModalHeader>
        ...
        <ModalBody p={6}>
          <VStack spacing={6} align="stretch">
            ...
            <FormControl>
              ...
              <RadioGroup value={mode} onChange={(val) => setMode(val as "EQUAL" | "PERCENTAGE")}>
                    ...
                    <HStack spacing={3} align="flex-start">
                      ...
                      <VStack align="start" spacing={0}>
                        <HStack spacing={1.5}>
                          ...
                          <Text fontSize="sm" fontWeight="bold">Percentage Split</Text>
                        </HStack>
                        <Text fontSize="2xs" color="gray.500">
                          Set custom percentage allocations for each step (e.g. 30% - 40% - 30%)
                        </Text>
                      </VStack>
                    </HStack>
                  </Box>
                    ...
                    <HStack spacing={3} align="flex-start">
                      ...
                      <VStack align="start" spacing={0}>
                        <HStack spacing={1.5}>
                          ...
                          <Text fontSize="sm" fontWeight="bold">Equal Split</Text>
                        </HStack>
                        <Text fontSize="2xs" color="gray.500">
                          Divide work value equally into a specific number of steps (e.g. 3 equal steps)
                        </Text>
                      </VStack>
                    </HStack>
                  </Box>
