...
const CardProject = memo(({ 
  ...
  const getDefaultConfig = () => {
    switch (variant) {
      case "manager":
        return {
          linkPath: linkPath || `projects-manager/detail?projectId=${data.id}`,
      ...
      default:
        return {
          linkPath: linkPath || `project-development/development?projectId=${data.id}`,
  ...
  return (
    ...
    >
      ...
      <CardHeader
        ...
        bgGradient={
          variant === "manager" 
            ? "linear(135deg, blue.600 0%, purple.500 50%, blue.400 100%)"
            : "linear(135deg, secondary.600 0%, blue.500 50%, secondary.400 100%)"
        }
        color="white"
        h="200px"
        display="flex"
          ...
          <VStack spacing={2} align="start">
            <HStack spacing={2} w="full" justify="space-between">
              <Text fontSize="xs" color="gray.500" fontWeight="medium">
                #{data.projectCode || data.projectNo}
              </Text>
              <HStack spacing={1}>
            ...
            {data.appsProject?.appName && data.appsProject.appName !== data.projectName && (
              ...
              <Button
                ...
                bgGradient={
                  variant === "manager"
                    ...
                    : "linear(to-r, secondary.500, blue.500)"
                }
                _active={{
                  bgGradient: variant === "manager"
